...
$url        = 'http://www.flashdevelop.org/downloads/releases/FlashDevelop-5.2.0.exe' # download url, HTTPS preferred
$url64      = '' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
$checksum   = 'bf7624b4effde92d0f07845f0b4713d73a387e1c0fa68203374f7e32f73f3a48'
...
$packageArgs = @{
  ...
  softwareName  = 'flashdevelop*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
